...
alias mycp_parallel_4="rclone copy --transfers 16 --create-empty-src-dirs --progress --copy-links --multi-thread-streams=4 --local-no-check-updated"
# alias mycp_parallel="rclone copy --transfers 16 --create-empty-src-dirs --progress --copy-links --multi-thread-streams=4 --multi-thread-chunk-size 1024M --multi-thread-write-buffer-size 512M --local-no-check-updated"
